const Footer = () => {
  return (
    <div className="bg-[#f4f4f4] px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw] mt-10 p-5">
      <div className="flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 text-sm ">
        <div>
          <img src="/logo.svg" className="mb-5 w-32" alt="" />
      ...
      <div>
        ...
        <p className="py-5 text-sm text-center">
          Copyright 2024@fashion-fizz.com - All Right Reserved
        </p>
      </div>
    </div>
  );
